...
const createUsuario = async (req, res) => {
  ...
  try {
    ...
    await bitacora({
            req,
            res,
            descripcion: `Creación de nuevo usuario: ${usuario} asociado al empleado CI: ${empleado_ci} por el usuario ${req.user.usuario}`,
          });
...
const createCliente = async (req, res) => {
  ...
  try {
    ...
    await bitacora({
            req,
            res,
            descripcion: `Creación de nuevo cliente: ${nombre} con CI: ${ci1} por el usuario ${req.user.usuario}`,
          });
